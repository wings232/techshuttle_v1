...
?>
			...
			<div class="details_fil">
				<form method="post" enctype="multipart/form-data" class="course_descrip_check">
					<div class="feild_box">
							...
							<div class="input_box"><!-- input_box loop Start-->
								<div class="feild_head">
									<div class="head">Course description</div>
								</div>
								<div class="feild_action">
									<textarea name='product_descrip' id='product_descrip' placeholder=""></textarea>
								</div>
							</div><!-- input_box loop Ends-->
						...
						<div class="input_box"><!-- input_box loop Start-->
							<div class="feild_action">
								<input type="button" name='create_button' value="Create" onclick="courseDescrip_create()" />
...
<script type="text/javascript">
  load_data(1);
    ...
    {
      $.ajax({
        url:"course_description_c/process_page_c_descrip.php",
        method:"POST",
