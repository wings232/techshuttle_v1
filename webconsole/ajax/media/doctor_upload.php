...
<?php
  ...
  if(empty($errors)==true){
  	move_uploaded_file($file_tmp,"../../../images/consultant/".$file_name);
?>
	<div class="error_out">
		<input type='hidden' id='sfile_image' value="<?php echo $file_name; ?>" />
		<div class="success">
			<img width="30%" src="../images/consultant/<?php echo $file_name; ?>"/> Media photo moved successfully
		</div>
	</div>
<?php
  }else{
