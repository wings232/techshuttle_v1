...
?>
			...
			<div class="details_fil">
				<form method="post" enctype="multipart/form-data" class="course_fee_check">
					<div class="feild_box">
							<div class="input_box"><!-- input_box loop Start-->
								<div class="feild_head">
									<div class="head">Course Fees</div>
								</div>
								<div class="feild_action">
									<input type="text" name="course_fees" id="course_fees">
								</div>
							</div><!-- input_box loop Ends-->

							<div class="input_box"><!-- input_box loop Start-->
								<div class="feild_head">
									<div class="head">Select Price Type</div>
								</div>
								<div class="feild_action">
							...
							<div class="input_box"><!-- input_box loop Start-->
								<div class="feild_head">
									<div class="head">Course fee description</div>
								</div>
								<div class="feild_action">
									<textarea name='fee_content' id='fee_content' placeholder=""></textarea>
								</div>
							</div><!-- input_box loop Ends-->
...
?>
						...
						<div class="input_box"><!-- input_box loop Start-->
							<div class="feild_action">
								<input type="button" name='create_button' value="Create" onclick="courseFee_create()" />
...
<script type="text/javascript">
  load_data(1);
    ...
    {
      $.ajax({
        url:"courses_fee_c/process_page_c_fee.php",
        method:"POST",
