...
<body>
	<div class="right_container">
		...
		<div class="department_head">
			...
			<div class="select_d"><!--select_d Loop Starts -->
				<div class="select_design">
					<div class="select_design_head">
						<div class="filter_h">
	                        ...
	                        <div class="head" id="head_services">Select The Blog</div>
	                    </div>
...
?>
			...
			<div class="select_d_s"><!--select_d Loop Starts -->
				<div class="select_design_s">
					<div class="select_design_head_s">
						<div class="filter_h_s">
	                        <input type="hidden" class="parent_val" id="parent_val_s" />
	                        <input type="hidden" class="sub_val" id="sub_val_s" />
	                        <input type="hidden" class="cate_group_val" id="cate_group_val_s" />
	                        <input type="hidden" class="menu_slug" id="menu_slug_s" />
	                        <input type="hidden" class="level" id="level_s" />
	                        <div class="head" id="head_services_s">Select The Batch</div>
	                    </div>
	                    <div class="select_image_s"><center><img src='images/icons/arrow_c.png'/></center></div>
					</div>
					<div class="filter_drop_s">
						<div class="filter_search_s">
	                        <input type="text" placeholder="Search" />
	                    </div>
	                    <div class="filter_select_s">
	                        <ul>
	                        	<?php
	                        		$selectBlogSetuplevel= selectBlogSetuplevel("tbl_batch_setup","courses","Active");
									$selectBlogSetuplevel_json = json_decode($selectBlogSetuplevel, true);
									//print_r($accopany_filter_List_json);
									$selectBlogSetuplevel_json_count = isset($selectBlogSetuplevel_json['selectBlogSetuplevel_count'])?$selectBlogSetuplevel_json['selectBlogSetuplevel_count']:"";
									if($selectBlogSetuplevel_json_count > 0){

									

									foreach ($selectBlogSetuplevel_json['selectBlogSetuplevel_details'] as $blogSetup_lists) {
											$menu_id  = $blogSetup_lists["batch_id"];
											$menu_name = $blogSetup_lists["batch_name"];
											$seat_count = $blogSetup_lists["seat_count"];
											//$menu_sub_id = $blogSetup_lists["sub_id"];
											$menu_categories_group = $blogSetup_lists["post_type"];
											//$menu_level = $blogSetup_lists["level"];
											//$menu_slug = $blogSetup_lists["blog_slug"];
	                        	?>
	                            <li style="color: white; font-weight: normal; font-family:'Roboto Regular'">
	                            	<div class="first_l" parent_id="<?php echo $menu_id; ?>" sub_id="" cate_gro="<?php echo $menu_categories_group; ?>" level="<?php echo $seat_count; ?>" menu_slug=""><?php echo $menu_name; ?></div>
			...
			<div class="details_fil">
				<form method="post" enctype="multipart/form-data" class="batch_mapping_check">
					...
					<div class="feild_box">
							...
							<div class="input_box"><!-- input_box loop Start-->
								...
								<div class="feild_action">
									<div class="for_date">
										<input type="text" name="sposted_date" id='sposted_date' placeholder="Start date" />
										<script type="text/javascript">
			    							$(document).ready(function(){
			    							 $("#sposted_date").datepicker({
			    								 	dateFormat:'d-M-yy',
			    								 	timepicker:false,
			    								 	scrollInput: false,
			    								 	changeYear:true,
			                                    	...
			                                    	onClose: function() {
			    								 	...
			    								 	beforeShow:function(textbox, instance){
														$('.dates_picks_placer').append($('#ui-datepicker-div'));
													        /*onShow: function() {
								    	...
								    	<div class="dates_picks_placer"></div>
							    	</div>
								</div>
							...
							<div class="input_box"><!-- input_box loop Start-->
								...
								<div class="feild_action">
									<div class="for_date">
										<input type="text" name="sexpiry_date" id='sexpiry_date' placeholder="Expiry Date" />
										<script type="text/javascript">
			    							$(document).ready(function(){
			    							 $("#sexpiry_date").datepicker({
			    								 	dateFormat:'d-M-yy',
			    								 	timepicker:false,
			    								 	scrollInput: false,
			    								 	changeYear:true,
			                                    	...
			                                    	onClose: function() {
			    								 	...
			    								 	beforeShow:function(textbox, instance){
														$('.date_picks_placer').append($('#ui-datepicker-div'));
													        /*onShow: function() {
													          $('.date_picks_placer').append(this)
													        }*/
													    }
								    	...
								    	<div class="date_picks_placer"></div>
							    	</div>
								</div>
							</div><!-- input_box loop Ends-->
							...
							<div class="input_box"><!-- input_box loop Start-->
								...
								<div class="feild_action">
									<div class="new_select">
										<select id='descrip_status' name="descrip_status">
						...
						<div class="input_box"><!-- input_box loop Start-->
							<div class="feild_action">
								<input type="button" name='create_button' value="Create" onclick="batchMapping_create()" />
...
<script type="text/javascript">
  load_data(1);
    ...
    {
      $.ajax({
        url:"course_mapping_c/process_page_c_mapping.php",
        method:"POST",
