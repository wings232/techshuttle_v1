	...
	<div class="right_container">
		...
		<div class='main_cate'>
			<div class="create_level_one">
				<input type="button" name="create_main" value="Create Main" id='create_main' onclick='navigation_level_one("1","insert_query")'/>
		...
		<div class="content_table">
			...
			<?php
				...
				$selectNavigationRecordlevel= selectNavigationRecordlevel('tbl_navigation_setup',1);
			...
			<table class="level_one_table">
				<tr>
					...
					<td><input type="button" name="create_second" value="Create" id='create' onclick='navigationTwo("<?php  echo $cate_id; ?>","2","insert_query")'/></td>
					
					<td><input type="button" name="edit_second" value="Edit" id='edit' onclick='navigationUpdate("<?php  echo $pubName; ?>","<?php  echo $slug_info; ?>","<?php  echo $cate_id; ?>","1","Update_query")'/></td>
					<td><!-- <input type="button" name="delete_second" value="Delete" id='delete' onclick='locationDelete("<?php  // echo $cate_id; ?>","1","delete_query")'/> --></td>
				</tr>
				
			</table>
			<?php
				$selectNavigationRecordMultilevel= selectNavigationRecordMultilevel('tbl_navigation_setup',2,$cate_id);
			...
			<table class="level_two_table">
				<tr>
					...
					<td><input type="button" name="create_second" value="Create" id='create' onclick="navigationTwo('<?php  echo $cate_ids; ?>','3','insert_query')" /></td>
					
					<td><input type="button" name="edit_second" value="Edit" id='edit' onclick='navigationUpdate("<?php  echo $pubNames; ?>","<?php  echo $slug_infos; ?>","<?php  echo $cate_ids; ?>","2","Update_query")'/></td>
			...
			<?php
				$selectNavigationRecordMultilevel= selectNavigationRecordMultilevel('tbl_navigation_setup',3,$cate_ids);
				$selectNavigationRecordMultilevel_json = json_decode($selectNavigationRecordMultilevel, true);
			...
			<table class="level_three_table" >
				<tr>
					...
					<td><input type="button" name="create_second" value="Create" id='create' onclick="navigationTwo('<?php  echo $cate_idss; ?>','4','insert_query')" /> </td>
					<td><input type="button" name="edit_second" value="Edit" id='edit' onclick='navigationUpdate("<?php  echo $pubNamess; ?>","<?php  echo $slug_infoss; ?>","<?php  echo $cate_idss; ?>","3","Update_query")'/></td>
			...
			<?php
				$selectNavigationRecordMultilevel= selectNavigationRecordMultilevel('tbl_navigation_setup',4,$cate_idss);
				$selectNavigationRecordMultilevel_json = json_decode($selectNavigationRecordMultilevel, true);
			...
			<table class="level_three_table three_four" >
				<tr>
					...
					<td><input type="button" name="create_second" value="Create" id='create' onclick="navigationTwo('<?php  echo $cate_idss_four; ?>','5','insert_query')" /> </td>
					<td><input type="button" name="edit_second" value="Edit" id='edit' onclick='navigationUpdate("<?php  echo $pubNamess_four; ?>","<?php  echo $slug_infoss_four; ?>","<?php  echo $cate_idss_four; ?>","4","Update_query")'/></td>
			...
			<?php
				$selectNavigationRecordMultilevel= selectNavigationRecordMultilevel('tbl_navigation_setup',5,$cate_idss_four);
				$selectNavigationRecordMultilevel_json = json_decode($selectNavigationRecordMultilevel, true);
			...
			<table class="level_three_table three_five" >
				<tr>
					...
					<td><input type="button" name="edit_second" value="Edit" id='edit' onclick='navigationUpdate("<?php  echo $pubNamess_five; ?>","<?php  echo $slug_infoss_five; ?>","<?php  echo $cate_idss_five; ?>","5","Update_query")'/></td>
