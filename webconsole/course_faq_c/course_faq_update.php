<?php
	...
	$selectCourseListRecordDet= selectCourseListRecordDet('tbl_product_faq',$articlesId);
...
;
		...
		foreach ($selectCourseListRecordDet_json['selectCourseListRecordDet_details'] as $CourseListDetails) {
			...
			$product_faq = $CourseListDetails["product_faq"];			
	...
	<div class="media_cont media_doc">
		...
		<div class="media_box">
			...
			<div class="head_input">
				<textarea id='uproduct_faqs' name='uproduct_faqs'><?php echo $product_faq; ?></textarea>
			</div>
		</div>
		...
		<div class="media_button">
			<div class="button">
				<ul>
					<li>
						<div class="approval" onclick="updateCoursefaqRecord('<?php echo $articlesId; ?>')">Update</div>
