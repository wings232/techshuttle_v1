<?php
	...
	$uproduct_faqs = isset($_REQUEST['uproduct_faqs'])?$_REQUEST['uproduct_faqs']:"";
	$media_content_hentities = htmlentities($uproduct_faqs);
	...
	$update_data = array(  
      ...
      if(update("tbl_product_faq", $update_data, $where_condition))  
      {  
           //echo 'good';
       
      $selectCatebasedRecord = selectCatebasedRecord('tbl_product_faq','courses');
...
<tr>   
      ...
      <td><div class="c_update_button" onclick="update_course_faq('<?php echo $nav_id; ?>','<?php echo $product_pri_slug; ?>')">View</div></td>
    </tr>
