							...
							<div class="input_box"><!-- input_box loop Start-->
								...
								<div class="feild_action">
									...
									foreach ($selectListRecordlevel_json['selectListRecordlevel_details'] as $list_details) {
												...
												$product_faq = $list_details['product_faq'];
												
												
											?>							
											<option value='<?php echo $cate_id; ?>'><?php echo $product_faq; ?></option>
											<?php
											}
										}else{
										?>
...
?>
							...
							<div class="input_box"><!-- input_box loop Start-->
								...
								<div class="feild_action">
									...
									$selectCategoriesRecordMultilevel = selectCategoriesRecordMultilevel('tbl_categories_groups',3,36);
							...
							<div class="input_box"><!-- input_box loop Start-->
								...
								<div class="feild_action">
									<textarea name='product_faq' id='product_faq' placeholder=""></textarea>
								</div>
							</div><!-- input_box loop Ends-->
						...
						<div class="input_box"><!-- input_box loop Start-->
							<div class="feild_action">
								<input type="button" name='create_button' value="Create" onclick="coursefaq_create()" />
