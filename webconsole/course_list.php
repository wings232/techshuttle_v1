...
?>
			...
			<div class="details_fil">
				<form method="post" enctype="multipart/form-data" class="course_list_check">
					<div class="feild_box">
						<div class="input_box"><!-- input_box loop Start-->
							...
							<div class="feild_action">
								<div class="new_select">
									<select id='list_levels' name="list_levels" onchange="select_list_levels()">
...
<script type="text/javascript">
  load_data(1);
    ...
    {
      $.ajax({
        url:"course_list_c/process_page_c_list.php",
        method:"POST",
