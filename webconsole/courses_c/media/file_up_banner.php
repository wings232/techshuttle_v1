	...
	function tc_file_upload($file_info)
{
     ...
     **/
    while (file_exists("../../../images/courses/main/" . $file_name . "." . $extension)) {
    ...
    $file_target_location = "../../../images/courses/main/" . $file_name_complete;
	...
	$target_dir = "../../../images/courses/main/";
  ...
  if(empty($errors)==true ){
  	//echo $errors;
  	move_uploaded_file($file_tmp,"../../../images/courses/main/".$file_name);
?>
	<div class="error_out">
		<input type='hidden' id='sfile_image_banner' value="<?php echo $file_name; ?>" />
		<div class="success">
			<img width="30%" src="../images/courses/main/<?php echo $file_name; ?>"/>  File Uploaded successfully
		</div>
	</div>
