	...
	function tc_file_upload($file_info)
{
     ...
     **/
    while (file_exists("../../../images/menu_image/" . $file_name . "." . $extension)) {
    ...
    $file_target_location = "../../../images/menu_image/" . $file_name_complete;
  ...
  if(empty($errors)==true ){
  	//echo $errors;
  	move_uploaded_file($file_tmp,"../../../images/menu_image/".$file_name);
?>
	<div class="error_out">
		<input type='hidden' id='sfile_image' value="<?php echo $file_name; ?>" />
		<div class="success">
			<img width="100%" src="../images/menu_image/<?php echo $file_name; ?>"/>  File Uploaded successfully
		</div>
	</div>
