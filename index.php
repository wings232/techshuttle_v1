...
<body>
    ...
    <section class="main-banner">
        ...
        <div class="main-banner-bg-aliment-wp">
            <div class="bg-aliment-1 rotate-animation">
                <img src="images/svg/01.svg" width="30" height="30" alt="Aliment">
            </div>
            <div class="bg-aliment-2 animate-this" style="transform: translateX(20px) translateY(-10px);">
                <img src="images/svg/02.svg" width="26" height="22" alt="Aliment">
            </div>
            <div class="bg-aliment-3 zoom-fade-animation">
                <img src="images/svg/03.svg" width="44" height="44" alt="Aliment">
            </div>
            <div class="bg-aliment-4 rotate-animation">
                <img src="images/svg/01.svg" width="30" height="30" alt="Aliment">
            </div>
            <div class="bg-aliment-5 animate-this" style="transform: translateX(20px) translateY(-10px);">
                <img src="images/svg/04.svg" width="26" height="22" alt="Aliment">
            </div>
            <div class="bg-aliment-6 zoom-fade-animation">
                <img src="images/svg/03.svg" width="44" height="44" alt="Aliment">
            </div>
            <div class="bg-aliment-7 rotate-animation">
                <img src="images/svg/05.svg" width="30" height="30" alt="Aliment">
            </div>
            <div class="bg-aliment-8 animate-this" style="transform: translateX(20px) translateY(-10px);">
                <img src="images/svg/06.svg" width="19" height="16" alt="Aliment">
            </div>
            <div class="bg-aliment-9 animate-this" style="transform: translateX(20px) translateY(-10px);">
                <img src="images/svg/07.svg" width="38" height="32" alt="Aliment">
            </div>
            <div class="bg-aliment-10 zoom-fade-animation">
                <img src="images/svg/03.svg" width="29" height="29" alt="Aliment">
            </div>
            <div class="bg-aliment-11 zoom-fade-animation">
                <img src="images/svg/03.svg" width="29" height="29" alt="Aliment">
            </div>
            <div class="bg-aliment-12 animate-this" style="transform: translateX(20px) translateY(-10px);">
                <img src="images/svg/08.svg" width="34" height="34" alt="Aliment">
            </div>
            <div class="bg-aliment-13 zoom-fade-animation">
                <img src="images/svg/03.svg" width="44" height="44" alt="Aliment">
            </div>
            <div class="bg-aliment-14 rotate-animation">
                <img src="images/svg/09.svg" width="30" height="30" alt="Aliment">
            </div>
            <div class="bg-aliment-15 zoom-fade-animation">
                <img src="images/svg/03.svg" width="58" height="58" alt="Aliment">
            </div>
            <div class="bg-aliment-16 animate-this" style="transform: translateX(20px) translateY(-10px);">
                <img src="images/svg/10.svg" width="26" height="22" alt="Aliment">
            </div>
            <div class="bg-aliment-17 rotate-animation">
                <img src="images/svg/11.svg" width="30" height="30" alt="Aliment">
            </div>
        </div>
            ...
            <div class="row">
                <div class="ban_left">
                    <div class="banner-content">
                        <span class="sub-title wow fadeup-animation animated" data-wow-duration="0.8s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.2s;">More
                            Then 26,000+ Courses From Us</span>
                        <h1 class="h1-title wow fadeup-animation animated" data-wow-duration="0.8s" data-wow-delay="0.3s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.3s;">Learn
                            Anything Anywhere Now !</h1>
                        <div class="banner-description-wp wow fadeup-animation animated" data-wow-duration="0.8s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.4s;">
                            <div class="banner-description-text">
                                <p>World class training and education by out top teachers for the best stadues</p>
                            </div>
                            <div class="students-list">
                                <ul>
                                    <li>
                                        <div class="students-image">
                                            <img src="images/student-01.jpg" width="60" height="60" alt="Students Have Passed">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="students-image">
                                    ...
                                    <li>
                                        <div class="students-image">
                                            <img src="images/student-03.jpg" width="60" height="60" alt="Students Have Passed">
                                        </div>
                                    </li>
                                    <li>
                                        <div class="students-image">
                                            <div class="students-counter-box" id="students_Passed_counter">
                                                <h5 class="h5-title"><span class="counting" data-count="25">25</span>k
                                                </h5>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                                <div class="students-list-text">
                ...
                <div class="ban_right">
                    <div class="banner-image-content wow fadeup-animation animated" data-wow-duration="0.8s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.4s;">
                        <div class="banner-image-shape">
                            <img src="images/svg/arrow_des.svg" class="move-element-animation-1" width="123" height="142" alt="Arrow Aliment">
                        </div>
                        <div class="banner-image-box">
                            <div class="banner-image">
                                <img src="images/banner-img.png" width="510" height="697" alt="Banner Image">
                            </div>
                        </div>
                        <div class="congra-box move-element-animation-2">
                            <div class="congra-icon">
                                <img src="images/svg/note-icon.svg" width="24" height="30" alt="Note Icon">
                            </div>
                            <div class="congra-text">
                                <h5 class="h5-title">Congratulations</h5>
                                <p>Our Admission Completed</p>
                            </div>
                        </div>
                        <div class="certification-box-wp">
        ...
        <div class="blog_t_con"><!--blog_t_con Starts -->
            <div class="blog_t_center"><!--blog_t_center Starts -->
                <div class="blog_t"><!--blog_t Starts -->
                    <div class="blog_heads"><!--blog_heads Starts -->
                        <div class="pop_course">
                            <div class="pop_title">
                        ...
                        <div class="blog_cate">
                            <div class="banner-btn wow fadeup-animation animated" data-wow-duration="0.8s" data-wow-delay="0.5s" style="visibility: visible; animation-duration: 0.8s; animation-delay: 0.5s;">
                                <a href="" class="sec-btn" title="Get Started"><span>View All Blogs</span></a>
                            </div>
                        </div>
                    </div>  <!--blog_heads Ends -->
                    <div class="image_blog">
                        <ul>
                            <li><!--Loop Starts -->
                                <div class="image">
                                    <div class="img_b">
                                        <img src="images/label/01.jpg" alt="img">
                                        <img src="images/label/01.jpg" alt="img">
                                    </div>
                                </div>
                                <div class="img_cont">
                                    ...
                                    <div class="head">
                                        The Power of Lifelong Learning Why Education Never Stops
                                    </div>
                                    <div class="read">
                                        <a href="#">
                                            Read More
                            ...
                            <li><!--Loop Starts -->
                                <div class="image">
                                    <div class="img_b">
                                        <img src="images/label/02_1.webp" alt="img">
                                        <img src="images/label/02_1.webp" alt="img">
                                    </div>
                                </div>
                                <div class="img_cont">
